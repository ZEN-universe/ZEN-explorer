 ...
 * @param solution The solution for which to generate the suffix.
 * @returns A formatted string that can be used as a suffix for the solution.
 */
export function generateSolutionSuffix(solution: ActivatedSolution): string {
...
/**
 * Find solution by its suffix in the list of activated solutions.
 * @param solutions The list of activated solutions.
 * @param suffix The suffix to search for, typically generated by generateSolutionSuffix.
 * @returns The found solution or null if not found.
 */
export function findSolutionBySuffix(
	solutions: (ActivatedSolution | null)[],
	suffix: string | undefined
): ActivatedSolution | null {
	if (!suffix) return null;
	const solution = solutions.find(
		(solution) => solution && generateSolutionSuffix(solution) === suffix
	);
