<script lang="ts">
	...
	import MapPlot, { type Pie } from '$components/MapPlot.svelte';
		...
		const items: ContextMenuItem[] = [
			{
				...
				href: addParametersToPath('/explorer/transition/capacity/', {
		...
		{#if !solutionLoading && selectedSolution}
			<FilterSection title="Variable Selection">
				<Dropdown
					...
					error={selectedCarrier === null ? 'Please select a carrier' : undefined}
