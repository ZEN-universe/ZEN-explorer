            ...
            >
                ...
                <div class="links" class:active={links_active}>
                    <div class="sublink l1">
                        <a href="./transition/capacity/" class="link-secondary"
                            >Capacity</a
                        >
                    </div>
                    <div class="sublink l2">
                        <a
                            href="./transition/production/"
                            class="link-secondary">Production</a
                        >
                    </div>
                    <div class="sublink l3">
                        <a href="./transition/emissions/" class="link-secondary"
                            >Emissions</a
                        >
                    </div>
                    <div class="sublink l4">
                        <a href="./transition/costs/" class="link-secondary"
                            >Costs</a
                        >
                    </div>
                    <button
