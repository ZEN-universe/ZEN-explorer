...
{#snippet navButton(href: string, label: string, iconClass: string)}
	<a
		{href}
		aria-label={label}
		class="h-10 w-8 rounded-lg p-2 text-center text-gray-700 hover:bg-gray-200 sm:w-10 dark:text-gray-200 dark:hover:bg-gray-700"
		title={label}
		target="_blank"
	>
	...
	<div class="container mx-auto flex justify-between gap-4 px-4">
		...
		<div class="flex items-center gap-2">
			...
			<a
				...
				class="inline-flex h-10 w-8 flex-col justify-center rounded-lg p-2 text-center font-bold text-gray-700 hover:bg-gray-200 sm:w-10 dark:text-gray-200 dark:hover:bg-gray-700"
				aria-label="Reliability and Risk Engineering Lab at ETH Zurich"
				title="Reliability and Risk Engineering Lab at ETH Zurich"
				target="_blank"
			>
				<RRELogo />
			</a>
	...
	>
		...
		>
			<div class="hidden lg:block">
				<img src="/zen_garden_700x700.png" alt="ZEN-garden Logo" />
			</div>
			<div class="lg:pt-16">
				<h1 class="mb-12 text-5xl font-bold xl:text-6xl">Welcome to our ZEN&#8209;garden</h1>

				<p class="mx-auto mb-12 text-lg leading-relaxed lg:text-xl">
					ZEN-garden is an open-source optimization software to model multi-year energy system
					transition pathways. To support research focused on the transition of sector-coupled
					energy systems toward net-zero emissions, ZEN-garden is built upon two principles:
					optimizing highly complex sector-coupled energy transition pathways and supporting
					user-friendly data handling through small, flexible, and robust input datasets.
				</p>

				<p class="mb-12 text-2xl font-bold lg:text-3xl">
		...
		<div class="flex items-center justify-center">
			<a
				href={resolve('/explorer/map/capacity') +
					'?solution=technology_optimism_pessimism.Crystal_Ball&tech=conversion&car=electricity'}
...
<div class="section container mx-auto mb-12 px-4 lg:mb-24 lg:gap-12 xl:max-w-7xl">
	...
	>
		...
		<div
			class="grid gap-8 border-b border-gray-400 px-4 py-8 md:px-8 lg:grid-cols-3 lg:px-12 dark:border-gray-900"
		>
			<div class="">
				<h3 class="mb-4 text-3xl font-bold">Project Structure</h3>

				<p class="text-lg">
					The project structure is designed to facilitate easy navigation and management of your ZEN
					model components.
				</p>
			</div>
			<div class="col-span-2 mx-auto max-w-3xl">
				{#if !isDarkTheme}
					<video autoplay loop muted playsinline class="w-full">
						...
						/>
						<source
							src="/opt/build_your_model_512.mp4"
		...
		<div
			class="grid grid-cols-1 gap-8 border-b border-gray-400 px-4 py-8 md:px-8 lg:grid-cols-3 lg:gap-12 lg:px-12 dark:border-gray-900"
		>
			<div>
				<h3 class="mb-4 text-3xl font-bold">ZEN-creator</h3>

				<p class="mb-8 text-lg">
					A support tool to build your case study of the European sector-coupled transition pathway.
				</p>
		...
		<div class="px-4 py-8 md:px-8 lg:px-12">
			...
			<p class="mb-8 text-lg">
				These publications present the ZEN-garden software and its application to analyze multi-year
				transition pathways of sector-coupled energy systems.
			</p>
		...
		>
			...
			<div>
				...
				<p class="mb-8 text-lg">
					...
					and no adaptation of the codebase is required.
				</p>
			</div>
		</div>
		<div
			class="grid gap-8 border-b border-gray-400 px-4 py-8 md:px-8 lg:grid-cols-3 lg:gap-12 lg:px-12 dark:border-gray-900"
		>
			<div>
				<h3 class="mb-4 text-3xl font-bold">Getting started</h3>

				<p class="text-lg">
					Create your first model in three simple steps: (1) install ZEN-garden, (2) run the
					optimization, and (3) visualize the results.
				</p>
			</div>

			<div
				class="terminal col-span-2 rounded-xl bg-slate-900 p-6 font-mono text-sm leading-relaxed text-slate-300 shadow-xl ring-1 ring-slate-800 md:text-base"
			>
				<!-- Install zen-garden -->
...
<div class="section container mx-auto mb-12 px-4 lg:mb-24 lg:gap-12 xl:max-w-7xl">
	...
	>
		...
		<div class="grid gap-8 px-4 pt-8 md:px-8 lg:gap-12 lg:px-12 xl:grid-cols-3">
			<div>
				<h3 class="mb-4 text-3xl font-bold">ZEN-explorer</h3>
		...
		<div class="flex items-center justify-center">
			{#if !isDarkTheme}
				<img
					...
					class="w-32 sm:w-48 md:w-56 lg:w-96 xl:w-md"
				/>
			{:else}
				<img
