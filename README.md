...
> [!NOTE]
> If you want to host ZEN Explorer on your own, this approach is also recommendet since you only have to use FastAPI to act as an API Server as well as the Webserver that hosts the static files.
